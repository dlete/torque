...
base_url = 'http://checkme.heanet.ie/api/v1/audits/ne_transceiver/'
ne_id = 257     # dist1-itb.nn.hea.net
#ne_id = 281     # dist2-itb.nn.hea.net
#ne_id = 448     # edge3-testlab.nn.hea.net
#ne_id = 336     # edge1-ipa.nn.hea.net
...
if 'detail' in audit_report_dict:
    ...
    if audit_report_dict['overall_audit_result'] == 'FAIL':
        ...
        for l in audit_report_dict['report_warning']:
            report_text = "\n".join([report_text, l])
...
#base_url = 'http://checkme.heanet.ie/api/v1/audits/ne_keywords/'
#base_url = 'http://checkme.heanet.ie/api/v1/audits/ne_isis/'
#base_url = 'http://checkme.heanet.ie/api/v1/audits/ne_nni_description/'
base_url = 'http://checkme.heanet.ie/api/v1/audits/ne_transceiver/'
...
msg['Subject'] = "Audit report for RMAN Transceivers on " + report_timestamp
